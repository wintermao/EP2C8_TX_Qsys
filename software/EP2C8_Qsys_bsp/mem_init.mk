...
# Memory: epcs_flash
MEM_0 := nios2_epcs_flash_boot_rom
$(MEM_0)_NAME := epcs_flash
...
$(MEM_0)_START := 0x01003000
$(MEM_0)_END := 0x010037ff
$(MEM_0)_HIERARCHICAL_PATH := epcs_flash
$(MEM_0)_WIDTH := 32
...
.PHONY: epcs_flash
epcs_flash: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym $(MEM_0).flash

# Memory: onchip_ram
MEM_1 := nios2_onchip_ram
...
$(MEM_1)_START := 0x01001000
$(MEM_1)_END := 0x01001fff
